    ...
    switch (err.keyword) {
        ...
        case 'enum':
            return {
                ...
                fix: `Allowed values: ${err.params.allowedValues.join(', ')}`,
            };
        ...
        case 'pattern':
            return {
                ...
                fix: patternFixHint(path, err.params.pattern),
            };
        case 'minLength':
            return {
                type: 'error',
...
function mapAllOfError(err, ruleIndex) {
...
function patternFixHint(path, pattern) {
