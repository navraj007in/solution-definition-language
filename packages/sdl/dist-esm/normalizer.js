...
function inferDefaultCloud(sdl) {
...
function defaultScalingForStage(stage) {
    switch (stage) {
        case 'Growth':
...
function applyRegionDefaults(sdl, inf) {
...
function applyDatabaseNameDefault(sdl, inf) {
...
function applyFrontendTypeDefaults(sdl, inf) {
...
function applyBackendTypeDefaults(sdl, inf) {
...
function applyRuntimeDefaults(sdl, inf) {
...
function applyNetworkingDefaults(sdl, inf) {
    if (!sdl.deployment)
        return;
...
function applyCiCdDefaults(sdl, inf) {
    if (!sdl.deployment)
        return;
...
function applyAvailabilityDefaults(sdl, inf) {
    if (!sdl.nonFunctional?.availability)
        return;
...
function applySecurityDefaults(sdl, inf) {
    if (!sdl.nonFunctional?.security)
        return;
...
function applyOrmDefaults(sdl, inf) {
    const backends = sdl.architecture.projects.backend;
    if (!backends)
        return;
...
function applyTestingDefaults(sdl, inf) {
    if (!sdl.testing)
        return;
    const backends = sdl.architecture.projects.backend;
...
function applyObservabilityDefaults(sdl, inf) {
    if (!sdl.observability)
        return;
