/**
 * SDL v1.1 TypeScript Type Definitions
 * Generated from packages/sdl/src/types.ts
 *
 * This is the canonical TypeScript interface definition for SDL documents.
 * When you import SDL types in TypeScript, this ensures your code matches
